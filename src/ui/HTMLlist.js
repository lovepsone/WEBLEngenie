...
var DataHTML = {
	...
	'Biomes': {
		...
		'Buttons': ['bGenNoise', 'bNoiseApply',
			...
			'bTropicalSeasonalForest', 'bTropicalRainForest', 'bAsphaltType1'
		],
	...
	'Texture': {
		'Options': ['sOcean', 'sBeach', 'sScorched',
			...
			'sTropicalSeasonalForest', 'sTropicalRainForest', 'sAsphaltType1'],
		'Values': ['vOcean', 'vBeach', 'vScorched',
			...
			'vTropicalSeasonalForest', 'vTropicalRainForest', 'vAsphaltType1'],
...
let HTMLlist = [
	...
	{'tag': 'div', 'id': 'sidebar', 'children': [
		...
		{'tag': 'div', 'id': DataHTML.RightBar.Contents[1], 'style': 'display: none;padding: 6px 12px;border: 1px solid #888;border-top: none; text-align: center;', 'children': [
			...
			{'tag': 'button', 'id': DataHTML.Biomes.Buttons[16], 'class':'c0c0c0','style':'text-align: center; width: 220px; background: #c0c0c0;', 'text': txt.TabEditBiomes[19]},
			{'tag': 'hr'},
			{'tag': 'br'},
		...
		{'tag': 'div', 'id': DataHTML.RightBar.Contents[3], 'style': 'display: none;padding: 6px 12px;border: 1px solid #888;border-top: none; text-align: center;', 'children': [
			...
			{'tag': 'label', 'id': DataHTML.Texture.Values[14], 'class': CLASSTULLTIP, 'style': StyleIconLabelTexture, 'text': txt.TabEditTexture[16], 'children': [
				{'tag': 'input', 'id': DataHTML.Texture.Options[14], 'type':'file', 'style': StyleIconLoadTexture},
				{'tag': 'span', 'data-tooltip-css': cssToolTip, 'class': TOOLTIPWIND, text: txt.TabEditTexture[16]},
			]},
			{'tag': 'br'},
			{'tag': 'br'},
			{'tag': 'button', 'id': DataHTML.Texture.Buttons[0], 'style':'text-align: center; width: 120px;', 'text': txt.TabEditTexture[17]},
